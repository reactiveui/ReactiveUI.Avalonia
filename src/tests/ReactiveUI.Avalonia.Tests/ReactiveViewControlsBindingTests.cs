...
/// <summary>Tests for ReactiveUserControl ViewModel and DataContext synchronization.</summary>
public class ReactiveViewControlsBindingTests
{
    /// <summary>Verifies that setting DataContext syncs to ViewModel and vice versa.</summary>
    ...
    /// <summary>A test view for VM.</summary>
